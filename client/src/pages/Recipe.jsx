...
const Recipe = () => {
  ...
  const handleSaveAsPDF = async () => {
    ...
    doc.text("Fernheilpraxis - Praxisgemeinschaft", pageWidth / 2, currentY, {
      align: "center",
    });
    ...
    doc.setFontSize(12);
    doc.setTextColor(0, 0, 0);
    doc.text("Heilpraktiker Matthias Cebula", pageWidth / 2, currentY, {
      align: "center",
    });
    currentY += 6;
    doc.setTextColor(33, 150, 243);
    doc.text("www.fernheilpraxis.com", pageWidth / 2, currentY, {
      align: "center",
    });
    currentY += 6;
    doc.setTextColor(100, 100, 100);
    doc.text("info@fernheilpraxis.com", pageWidth / 2, currentY, {
      align: "center",
    });
    currentY += 8;
